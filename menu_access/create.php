...
// Check access to create menu access
if (!hasAccess('menu_access', 'add')) {
    $_SESSION['error'] = "Akses tidak diizinkan untuk menambah Menu Access";
    header("Location: index.php");
    exit();
}
...
// Get all available menus (you can define this based on your system)
$available_menus = [
    'dashboard' => 'Dashboard',
    'master' => 'Master Data',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($role_id) || empty($menu_name)) {
        ...
        // Check if menu access already exists for this role and menu
        ...
        if ($check_result->num_rows > 0) {
            ...
            $sql = "INSERT INTO menu_access (role_id, menu_name, can_view, can_add, can_edit, can_delete, can_approve, can_export, can_import, can_setup_split, can_complete, can_send_wa) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param('isiiiiiiiiii', $role_id, $menu_name, $can_view, $can_add, $can_edit, $can_delete, $can_approve, $can_export, $can_import, $can_setup_split, $can_complete, $can_send_wa);
            
            if ($stmt->execute()) {
                $success = "Menu access berhasil ditambahkan!";
                // Clear form
                $_POST = array();
            } else {
                $error = "Gagal menambahkan menu access: " . $conn->error;
            }
        }
    }
}
...
<head>
    ...
    <title>Tambah Menu Access - MINVEN</title>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="menu_name" name="menu_name" class="form-select" required>
                                            ...
                                            <?php foreach ($available_menus as $key => $name): ?>
                                                <option value="<?= $key ?>" <?= (isset($_POST['menu_name']) && $_POST['menu_name'] == $key) ? 'selected' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_view" name="can_view" class="form-check-input" 
                                                       <?= (isset($_POST['can_view']) && $_POST['can_view']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_add" name="can_add" class="form-check-input"
                                                       <?= (isset($_POST['can_add']) && $_POST['can_add']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_edit" name="can_edit" class="form-check-input"
                                                       <?= (isset($_POST['can_edit']) && $_POST['can_edit']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_delete" name="can_delete" class="form-check-input"
                                                       <?= (isset($_POST['can_delete']) && $_POST['can_delete']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_approve" name="can_approve" class="form-check-input"
                                                       <?= (isset($_POST['can_approve']) && $_POST['can_approve']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_export" name="can_export" class="form-check-input"
                                                       <?= (isset($_POST['can_export']) && $_POST['can_export']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_import" name="can_import" class="form-check-input"
                                                       <?= (isset($_POST['can_import']) && $_POST['can_import']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-3" id="setup_split_permission_div" style="display: none;">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_setup_split" name="can_setup_split" class="form-check-input"
                                                       <?= (isset($_POST['can_setup_split']) && $_POST['can_setup_split']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2" id="complete_permission_div" style="display: none;">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_complete" name="can_complete" class="form-check-input"
                                                       <?= (isset($_POST['can_complete']) && $_POST['can_complete']) ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-2" id="send_wa_permission_div" style="display: none;">
                                            <div class="form-check">
                                                <input type="checkbox" id="can_send_wa" name="can_send_wa" class="form-check-input"
                                                       <?= (isset($_POST['can_send_wa']) && $_POST['can_send_wa']) ? 'checked' : '' ?>>
