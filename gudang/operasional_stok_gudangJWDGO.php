...
if (!checkAccess('gudang_JWDGO', 'view')) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reset_stok'])) {
    if (!checkAccess('gudang_JWDGO', 'delete')) {
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <?php $canAdd = checkAccess('gudang_JWDGO', 'add'); $canDelete = checkAccess('gudang_JWDGO', 'delete'); ?>
                        <?php if ($canAdd): ?>
                    ...
                    <table class="table table-hover mb-0" id="inventoryTable">
                        ...
                        <tbody>
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                $stokMinimum = 0;
                                $stokHabis = 0;
                                $canEditGlobal = checkAccess('gudang_JWDGO', 'edit');
                                $canDeleteGlobal = checkAccess('gudang_JWDGO', 'delete');
                            ...
                            <?php endwhile;
                                ...
                                if (!$result) {
                                    echo "<tr><td colspan='14' class='text-center text-danger'>Error executing query: " . $conn->error . "</td></tr>";
                                } else {
                                    echo "<tr><td colspan='14' class='text-center text-muted'>Tidak ada data stok untuk gudang ini.</td></tr>";
                                }
                            }
                            ?>
                        </tbody>
    ...
    <div class="modal fade" id="addStokModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="addStokForm" action="process_operasional_stok_gudangJWDGO.php" method="POST">
    ...
    <div class="modal fade" id="stokMasukModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form id="stokMasukModalForm" action="process_operasional_stok_gudangJWDGO.php" method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="editStokModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editStokForm" action="process_operasional_stok_gudangJWDGO.php?action=edit" method="POST">
                    <div class="modal-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyAllFilters() {
        ...
        rows.forEach(row => {
            ...
            const barcode = (row.getAttribute('data-barcode') || row.cells[2]?.textContent || '').toLowerCase();
    ...
    window.updateStok = function(input) {
        ...
        fetch('process_operasional_stok_gudangJWDGO.php', {
            method: 'POST',
            headers: {
    ...
    window.deleteStok = function(id) {
        if (confirm('Apakah Anda yakin ingin menghapus stok ini?')) {
            ...
            form.method = 'POST';
            form.action = 'process_operasional_stok_gudangJWDGO.php';
