            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <?php $canAdd = checkAccess('gudang', 'add'); $canDelete = checkAccess('gudang', 'delete'); ?>
                        <?php if ($canAdd): ?>
                    ...
                    <table class="table table-hover mb-0" id="inventoryTable">
                        ...
                        <tbody>
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                $stokMinimum = 0;
                                $stokHabis = 0;
                                $canEditGlobal = checkAccess('gudang', 'edit');
                                $canDeleteGlobal = checkAccess('gudang', 'delete');
    ...
    <div class="modal fade" id="addStokModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="addStokForm" action="process_operasional_stok_gudang01.php" method="POST">
    ...
    <div class="modal fade" id="stokMasukModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form id="stokMasukModalForm" action="process_operasional_stok_gudang01.php" method="POST">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="editStokModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editStokForm" action="process_operasional_stok_gudang01.php?action=edit" method="POST">
                    <div class="modal-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.updateStok = function(input) {
        ...
        fetch('process_operasional_stok_gudang01.php', {
            method: 'POST',
            headers: {
    ...
    window.deleteStok = function(id) {
        if (confirm('Apakah Anda yakin ingin menghapus stok ini?')) {
            ...
            form.method = 'POST';
            form.action = 'process_operasional_stok_gudang01.php';
