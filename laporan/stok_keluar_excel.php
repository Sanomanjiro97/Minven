...
// SQL query disesuaikan dengan tabel stok_keluar
$sql = "SELECT 
            ts.tanggal,
            b.kode_barang,
            b.nama_barang,
...
header('Content-Disposition: attachment; filename="Laporan Stok Keluar ' . date('Y-m-d') . '.xls"');
...
while($row = $result->fetch_assoc()) {
    $total_keluar += floatval($row['jumlah']);
...
echo '<td colspan="4">Total Keluar:</td>';
