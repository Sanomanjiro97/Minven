...
$filter_session_key = 'filter_laporan_adjustment_out';
if (isset($_GET['reset']) && (string)$_GET['reset'] === '1') {
    unset($_SESSION[$filter_session_key]);
    header('Location: adjustment_out.php');
    exit();
}
...
if (!$has_any_filter_param && !empty($saved_filters)) {
    ...
    if (!empty($redirect_params)) {
        header('Location: adjustment_out.php?' . http_build_query($redirect_params));
        exit();
    }
}
...
<head>
    ...
    <title>Laporan Adjustment Out - Sistem Inventory</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        <div class="row mb-3">
            <div class="col-12">
                <h2 class="page-title"><i class="bx bx-minus-circle me-2"></i>Laporan Adjustment Out</h2>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="adjustment_out.php?reset=1" class="btn btn-secondary">Reset</a>
                        <a href="adjustment_out_excel.php?start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>&gudang_id=<?= urlencode($gudang_id) ?>" class="btn btn-success">
