...
header('Content-Disposition: attachment; filename="Laporan Adjustment Out ' . date('Y-m-d') . '.xls"');
...
echo 'th { background-color: #dc3545; color: white; font-weight: bold; }';
echo '</style>';
echo '</head>';
echo '<body>';
echo '<table>';
...
echo '<td colspan="5">Total Adjustment Out:</td>';
