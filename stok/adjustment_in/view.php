...
$sql = "SELECT ts.*, g.nama_gudang
        ...
        WHERE ts.id = ? AND ts.jenis_transaksi = 'adjustment_in'";
...
<head>
    ...
    <title>Detail Adjustment In - Sistem Inventory</title>
            ...
            <div class="card">
                <div class="card-header" style="background-color: #28a745; color: white;">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="bx bx-plus-circle me-2"></i>Detail Adjustment In</h5>
                        <div>
