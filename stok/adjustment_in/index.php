...
if (!checkAccess('adjustment_in', 'view')) {
    $_SESSION['error'] = 'Anda tidak memiliki akses untuk melihat menu adjustment in!';
...
$filter_session_key = 'filter_stok_adjustment_in_index';
...
$sql = "SELECT
            ...
            GROUP_CONCAT(DISTINCT b.kode_barang SEPARATOR ', ') as kode_barang,
...
if ($stmt) {
    ...
    error_log("SQL Error: " . $error_msg . " - Query: " . $sql);
    die("Query error: " . $error_msg . "<br><pre>SQL: " . $sql . "</pre>");
}
...
<head>
    ...
    <title>Adjustment In - Sistem Inventory</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bx bx-plus-circle me-2"></i>Adjustment In</h2>
            <?php if (checkAccess('adjustment_in', 'add')): ?>
            <a href="create.php" class="btn btn-success">
                <i class='bx bx-plus'></i> Tambah Adjustment In
            </a>
            <?php endif; ?>
        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view.php?id=<?= $row['transaksi_id'] ?>" class="btn btn-sm btn-info">
