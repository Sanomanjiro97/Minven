...
$sql = "SELECT ts.*, g.nama_gudang
        ...
        WHERE ts.id = ? AND ts.jenis_transaksi = 'adjustment_out'";
...
<head>
    ...
    <title>Detail Adjustment Out - Sistem Inventory</title>
            ...
            <div class="card">
                <div class="card-header" style="background-color: #dc3545; color: white;">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="bx bx-minus-circle me-2"></i>Detail Adjustment Out</h5>
                        <div>
