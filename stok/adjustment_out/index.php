...
if (!checkAccess('adjustment_out', 'view')) {
    $_SESSION['error'] = 'Anda tidak memiliki akses untuk melihat menu adjustment out!';
...
$filter_session_key = 'filter_stok_adjustment_out_index';
...
$sql = "SELECT
        ...
        WHERE ts.jenis_transaksi = 'adjustment_out'";
...
<head>
    ...
    <title>Adjustment Out - Sistem Inventory</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bx bx-minus-circle me-2"></i>Adjustment Out</h2>
            <?php if (checkAccess('adjustment_out', 'add')): ?>
            <a href="create.php" class="btn btn-danger">
                <i class='bx bx-plus'></i> Tambah Adjustment Out
            </a>
            <?php endif; ?>
        </div>
