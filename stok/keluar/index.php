...
// Check access untuk menu stok_keluar
if (!checkAccess('stok_keluar', 'view')) {
    $_SESSION['error'] = 'Anda tidak memiliki akses untuk melihat menu stok keluar!';
...
$filter_session_key = 'filter_stok_keluar_index';
...
$sql = "SELECT
        ...
        WHERE ts.jenis_transaksi = 'keluar'";
...
// Query untuk dropdown gudang (tidak berubah)
$gudang_sql = "SELECT id, nama_gudang FROM gudang ORDER BY nama_gudang";
$gudang_result = $conn->query($gudang_sql);
?>
...
<head>
    ...
    <title>Stok Keluar - Sistem Inventory</title>
...
<body>
    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="create.php" class="btn btn-primary">
                <i class='bx bx-plus'></i> Tambah Stok Keluar
            </a>
        </div>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Tanggal</th>
                                <th>Gudang</th>
                                <th>Nama Barang</th> <!-- Tambah kolom Nama Barang -->
                                <th>Keterangan</th>
                                <th>Total Item</th>
                        ...
                        <tbody>
                            <?php while($row = $result->fetch_assoc()):
                                // Hitung total item menggunakan prepared statement
                                $trans_id = $row['id'];
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['nama_barang'] ?? '-') ?></td> <!-- Tampilkan nama_barang yang diagregasi -->
    ...
    <?php
    // Debugging - tampilkan query dan hasilnya (opsional, bisa dihapus setelah selesai debugging)
    // error_log("Query: " . $sql);
    // $debug_result = $conn->query($sql);
    // if ($debug_result) {
    //     error_log("Jumlah baris: " . $debug_result->num_rows);
    //     while($debug_row = $debug_result->fetch_assoc()) {
    //         error_log("Data: " . print_r($debug_row, true));
    //     }
    // }
    ?>
